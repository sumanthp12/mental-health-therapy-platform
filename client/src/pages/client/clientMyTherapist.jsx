      ...
      <div className="rounded-3xl bg-white p-10 shadow-sm">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-3 max-w-xl text-base leading-7 text-slate-500">
            Your intake information has been received. An administrator
            will review your information and assign a suitable therapist
            to you soon.
          </p>
          ...
          <div className="mt-6 rounded-2xl bg-blue-50 px-6 py-4">
            ...
            <p className="mt-1 text-sm text-blue-600">
              You'll be able to view your therapist's profile and
              communicate with them once the assignment is complete.
            </p>
          </div>
        </div>
      </div>
